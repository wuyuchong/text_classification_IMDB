...
\HRule \\[0.4cm]
{ \huge \bfseries 基于机器学习的电影评论情感分类}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\begin{center} \large
\textsc{\large 吴宇翀-2021210793}\\[0.5cm] % Minor heading such as course title
\textsc{\large 谢一鸣-2021210828}\\[0.5cm] % Minor heading such as course title
\textsc{\large 吴舫-2021210827}\\[0.5cm] % Minor heading such as course title
...
{\large 2022年1月16日}\\[2cm] % Date, change the \today to a set date if you want to be precise
