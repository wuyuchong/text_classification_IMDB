...
\textsc{\Large 大数据分析统计基础课程}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries 第七次课作业}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\textsc{\large 指导老师：盖玉洁}\\[0.5cm] % Minor heading such as course title
\end{center}
